          ...
          <>
            ...
            <div className="flex items-center gap-2">
              {data.author.imageUrl && (
                <div
                  className="size-5 rounded-full bg-secondary shrink-0"
        ...
        <div className="flex w-full flex-col items-center py-4">
          {data.title && (
            <div className="w-full max-w-3xl px-6 pb-10">
              <h1 className="text-base font-medium text-foreground text-center">{data.title}</h1>
          ...
          <div className="w-full max-w-3xl px-6 pt-8 pb-10">
            <div className="flex justify-center">
              <a href="/" className="flex flex-col items-center gap-3 text-muted-foreground hover:text-foreground transition-colors">
                ...
                <span className="text-[10px]">Made with Cycls</span>
              </a>
            </div>
          </div>
        </div>
