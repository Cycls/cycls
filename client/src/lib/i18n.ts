...
const translations = {
  en: {
    ...
    perMonth: "/ mo",
    needsOrgTitle: "Create an organization",
    needsOrgDesc: "You need an organization to subscribe to a team plan.",
    language: "العربية",
  ...
  ar: {
    ...
    perMonth: "/ شهر",
    needsOrgTitle: "إنشاء منظمة",
    needsOrgDesc: "تحتاج إلى منظمة للاشتراك في باقة الفريق.",
    language: "English",
