...
_DESIGN_TOOL = {
    ...
    "description": (
        ...
        "  RTL: for Arabic / Hebrew set text `align`:\"right\" (and give it a `w`); shaping, "
        "bidi (mixed digits / Latin) and diacritics are handled, so write the text "
        "naturally — but skip `letterSpacing` on Arabic.\n"
